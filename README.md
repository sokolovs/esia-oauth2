...
получение ключа ГОСТ 2012 в одном из сертификационных центров и использованием алгоритма подписи ГОСТ Р 34.10-2012.
Для этого необходимо установить на сервере КриптоПРО CSP, установить на контейнер с закрытым ключем, а так же
